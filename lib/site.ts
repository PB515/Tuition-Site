...
export const COURSES = [
  { label: "Class 9 Maths", note: "Build the base for the board year", href: "/courses" },
  { label: "Class 10 Maths", note: "Board-focused, concept and practice", href: "/class-10-maths-coaching-vadodara" },
  { label: "Class 11 Maths", note: "The jump to higher maths, made clear", href: "/courses" },
